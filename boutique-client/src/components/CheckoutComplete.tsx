...
// Import des formulaires Paydunya
...
const paymentMethodsByCountry: { [key: string]: PaymentMethod[] } = {
  ...
  'SN': [
    { id: 'orange-money-sn', name: 'Orange Money', logo: '/orange-money.png', type: 'mobile_money', country: 'SN', enabled: true },
    { id: 'free-money-sn', name: 'Free Money', logo: '/free-money.png', type: 'mobile_money', country: 'SN', enabled: true },
    { id: 'wave-sn', name: 'Wave', logo: '/wave.png', type: 'mobile_money', country: 'SN', enabled: true }
  ]
}
  ...
  const handleSubmit = async () => {
    ...
    try {
      const paymentData = {
        ...
        paymentMethod: 'orange-money-ci', // Méthode par défaut pour Paydunya
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8">
                  <PaymentMethodSelector
                    ...
                    amount={checkoutData?.price || price || 0}
                    currency="XOF"

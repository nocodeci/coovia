...
interface FreeMoneySenegalFormProps {
  paymentToken: string;
  customerName: string;
...
const FreeMoneySenegalForm: React.FC<FreeMoneySenegalFormProps> = ({
  paymentToken,
  customerName,
  customerEmail,
  amount,
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const laravelApiUrl = `${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/api/process-free-money-senegal-payment`;
      ...
      if (response.data.success) {
        ...
        setStatus('error');
        const errorMessage = response.data.message || 'Une erreur est survenue lors du paiement Free Money Sénégal.';
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Paiement Free Money Sénégal Réussi !</h3>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">
                Instructions Free Money Sénégal
              </h3>
        ...
        >
          {status === 'loading' ? (
            ...
            <>
              ...
              Payer avec Free Money {formatAmount(amount, currency)}
            </>
          )}
        </button>
...
export default FreeMoneySenegalForm; 
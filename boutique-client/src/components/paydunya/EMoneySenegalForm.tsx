...
interface EMoneySenegalFormProps {
  paymentToken: string;
  customerName: string;
...
const EMoneySenegalForm: React.FC<EMoneySenegalFormProps> = ({
  paymentToken,
  customerName,
  customerEmail,
  customerPhone,
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const laravelApiUrl = `${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/api/process-e-money-senegal-payment`;
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Paiement E-Money Réussi !</h3>
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
      <div className="mb-6">
        <div className="flex items-center mb-4">
          <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mr-4">
            <img 
              src="https://assets.cdn.moneroo.io/icons/circle/e_money_sn.svg"
              alt="E-Money Sénégal"
              className="w-6 h-6"
            />
          </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-blue-700 mt-1">
                Entrez votre numéro E-Money pour effectuer le paiement. Vous recevrez un SMS de confirmation.
              </p>
            </div>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative group">
            <div className="flex">
              ...
              <input
                ...
                className="flex-1 rounded-r-lg border-2 border-l-0 border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 disabled:bg-gray-50 disabled:cursor-not-allowed"
              />
            </div>
            ...
            <div className="mt-2 flex items-center space-x-2">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs text-blue-600 font-medium">Format : 7xxxxxxxx (numéro E-Money Sénégal)</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={status === 'loading'}
          className="w-full bg-blue-600 text-white py-3 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors duration-200"
        >
          {status === 'loading' ? (
...
export default EMoneySenegalForm; 
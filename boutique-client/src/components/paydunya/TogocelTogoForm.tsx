...
const TogocelTogoForm: React.FC<TogocelTogoFormProps> = ({
  paymentToken,
  customerName,
  customerEmail,
  customerPhone,
  ...
  // Extraire le numéro sans le préfixe +228 pour l'affichage
  const phoneWithoutPrefix = customerPhone.replace('+228', '');
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const laravelApiUrl = `${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/api/process-togocel-togo-payment`;
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Paiement Togocel Réussi !</h3>
      ...
      <div className="mb-6">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">
              Paiement par Togocel Money
            </h3>
            <p className="text-sm text-gray-600">Togo</p>
          </div>
        </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h4 className="text-sm font-medium text-green-800">Instructions</h4>
              <p className="text-sm text-green-700 mt-1">
                Entrez votre numéro Togocel pour effectuer le paiement. Vous recevrez un SMS de confirmation.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative group">
            <div className="flex">
              ...
              <input
                ...
                className="flex-1 rounded-r-lg border-2 border-l-0 border-gray-200 px-4 py-3 text-sm focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500/20 disabled:bg-gray-50 disabled:cursor-not-allowed"
              />
            </div>
            ...
            <div className="mt-2 flex items-center space-x-2">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs text-green-600 font-medium">Format : 9xxxxxxxx (numéro Togocel Togo)</span>
              </div>
            </div>
          </div>
        </div>
...
export default TogocelTogoForm; 
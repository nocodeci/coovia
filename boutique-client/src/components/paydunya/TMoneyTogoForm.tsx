...
const TMoneyTogoForm: React.FC<TMoneyTogoFormProps> = ({
  paymentToken,
  customerName,
  customerEmail,
  amount,
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const laravelApiUrl = `${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/api/process-t-money-togo-payment`;
      ...
      if (response.data.success) {
        ...
        setStatus('error');
        const errorMessage = response.data.message || 'Une erreur est survenue lors du paiement T-Money Togo.';
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
        <div className="flex items-center mb-4">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Paiement T-Money Togo Initié !</h3>
      ...
      <div className="mb-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">
                Instructions T-Money Togo
              </h3>
              <div className="mt-2 text-sm text-blue-700 space-y-1">
                <p>1. Assurez-vous d'avoir un compte T-Money actif</p>
                <p>2. Vérifiez que votre compte a suffisamment de fonds</p>
                <p>3. Entrez votre numéro de téléphone T-Money ci-dessous</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Format : xxxxxxxxx (numéro T-Money Togo)
          </p>
        </div>
        ...
        >
          {status === 'loading' ? (
            ...
            <>
              ...
              Payer avec T-Money {formatAmount(amount, currency)}
            </>
          )}
        </button>

...
const MTNCIForm: React.FC<MTNCIFormProps> = ({
  paymentToken,
  customerName,
  customerEmail,
  customerPhone,
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Paiement MTN Money Réussi !</h3>
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
      <div className="mb-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-yellow-800">Instructions MTN Money</h3>
              <div className="mt-2 text-sm text-yellow-700 space-y-1">
                <p>1. Assurez-vous d'avoir un compte MTN Money actif</p>
                <p>2. Vérifiez que votre compte a suffisamment de fonds</p>
                <p>3. Entrez votre numéro de téléphone MTN ci-dessous</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="mt-2 flex items-center space-x-2">
            <div className="flex items-center space-x-1">
              ...
              <span className="text-xs text-yellow-600 font-medium">
                Format : 07xxxxxxxx (numéro MTN Côte d'Ivoire)
              </span>
            </div>
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={status === 'loading'}
          className="w-full bg-yellow-600 hover:bg-yellow-700 disabled:bg-yellow-400 text-white font-medium py-3 px-4 rounded-md transition duration-200 ease-in-out disabled:cursor-not-allowed flex items-center justify-center"
        >
          {status === 'loading' ? (
            <>
            ...
            <>
              ...
              Payer avec MTN Money {formatAmount(amount, currency)}
            </>
          )}
        </button>

...
const MTNBeninForm: React.FC<MTNBeninFormProps> = ({
  paymentToken,
  customerName,
  customerEmail,
  customerPhone,
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const laravelApiUrl = `${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/api/process-mtn-benin-payment`;
      ...
      if (response.data.success) {
        ...
        setStatus('error');
        const errorMessage = response.data.message || 'Une erreur est survenue lors du paiement MTN Bénin.';
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
        <div className="flex items-center mb-4">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Paiement MTN Bénin Initié !</h3>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700 space-y-1">
                ...
                <p>4. Après soumission, vous recevrez un SMS</p>
                <p>5. Suivez les instructions du SMS pour finaliser</p>
              </div>
            </div>
          </div>
        </div>

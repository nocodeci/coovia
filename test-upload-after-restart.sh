...
echo "🧪 Test d'Upload Cloudflare après Redémarrage"
echo "=============================================="
echo ""
...
# Test 3: Test d'upload réel
echo "🔍 Test 3: Test d'upload de fichier..."
...
media_response=$(curl -s "https://api.wozif.com/api/stores/9fbbeec1-6aab-4de3-a152-9cf8ae719f62/media")
...
echo "💡 Si l'upload échoue encore, vérifiez que le serveur Forge a été redémarré"

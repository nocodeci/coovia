...
<head>
    ...
    <meta name="x-avatar" content="{{ asset('images/wozif-avatar.svg') }}">
    <meta name="x-profile-image" content="{{ asset('images/wozif-avatar.svg') }}">
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="subtitle">Félicitations {{ $userName }}, votre boutique est maintenant en ligne</div>
        </div>

        <div class="store-info">
            <div class="store-name">{{ $storeName }}</div>
            <div class="store-domain">🌐 {{ $storeDomain }}</div>
        ...
        <div class="payment-methods">
            ...
            <ul class="payment-list">
                @if(in_array('wozif', $paymentMethods))
                    <li class="payment-item">Wozif (par défaut)</li>
                @endif
                @if(isset($paymentMethods['monneroo']) && $paymentMethods['monneroo']['enabled'])
        ...
        <div style="text-align: center;">
            <a href="https://{{ $storeDomain }}" class="cta-button">

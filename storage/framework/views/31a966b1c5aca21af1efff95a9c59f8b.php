...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>
                Cet email a été envoyé à <strong><?php echo e($userEmail); ?></strong><br>
                © <?php echo e(date('Y')); ?> Wozif. Tous droits réservés.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/koffiyohanerickouakou/Documents/wozif/backend/resources/views/emails/otp.blade.php ENDPATH**/ ?>
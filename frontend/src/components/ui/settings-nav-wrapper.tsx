...
interface SettingsNavWrapperProps {
  children: React.ReactNode
  className?: string
}

export function SettingsNavWrapper({ children, className }: SettingsNavWrapperProps) {
  return (
    <div 
      className={cn(
        "relative bg-background w-full min-w-40 px-1 py-2 md:block",
        "rounded-xl border border-border/50 shadow-xl hover:shadow-2xl transition-all duration-300",

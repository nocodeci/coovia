...
export function SettingsNav({ children, className }: SettingsNavProps) {
  return (
    <div 
      className={cn(
        "relative bg-background hidden w-full min-w-40 px-1 py-2 md:block",
        "rounded-lg border border-border/50 shadow-sm hover:shadow-md transition-all duration-200",

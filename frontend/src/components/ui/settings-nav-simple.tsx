...
interface SettingsNavSimpleProps {
  children: React.ReactNode
  className?: string
}

export function SettingsNavSimple({ children, className }: SettingsNavSimpleProps) {
  return (
    <div 
      className={cn(
        "relative bg-background hidden w-full min-w-40 px-1 py-2 md:block",
        "rounded-lg border border-border/50 shadow-lg hover:shadow-xl transition-all duration-300",

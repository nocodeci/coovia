          ...
          <div className="hidden lg:block space-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Plateforme de commerce en ligne sécurisée</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Accédez à votre tableau de bord, gérez vos produits et suivez vos ventes en toute sécurité.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="flex items-center gap-3 p-4 bg-white/50 rounded-lg border border-gray-200/50">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Chargement rapide et fluide</p>
                </div>
              </div>
            </div>
          </div>

...
import { PromoCodesDynamicSearchBar } from "./promo-codes-dynamic-search-bar"

interface PromoCodesTopBarProps {
  searchQuery?: string
...
export function PromoCodesTopBar({
  searchQuery = "",
  selectedStatus = "",
  selectedType = "",
  totalCodes = 0,

...
import { PromoCodesTopBar } from "./components/promo-code-top-bar"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PromoCodesTopBar
        ...
        onCreateCode={() => console.log("Create code")}
        onViewAnalytics={() => console.log("View analytics")}
      />

      <div className="container mx-auto px-6 py-8" style={{ paddingTop: "5rem" }}>
